...
--
-- Host: localhost    Database: bd_notas
-- ------------------------------------------------------
...
INSERT INTO `ninos` VALUES (1,'Carlos'),(2,'Juan David'),(3,'Tatiana Restrepo'),(4,'Mariana Pajon'),(5,'James Rodriguez');
...
CREATE TABLE `observaciones` (
  ...
  PRIMARY KEY (`id`),
  KEY `nino` (`nino`),
  CONSTRAINT `observaciones_ibfk_1` FOREIGN KEY (`nino`) REFERENCES `ninos` (`id`)
...
-- Dump completed on 2017-08-01 19:14:42
